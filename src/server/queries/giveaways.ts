...
/**
 * List public giveaways for the landing grid.
 *
 * Only PUBLIC visibility rows in listable states are returned — drafts and
 * private/community giveaways never appear. Ordering keeps live giveaways
 * ahead of scheduled/ended ones.
 */
...
/** Count of currently-live public giveaways (for the hero stat). */
...
/** Distinct chains that currently have public giveaways (for filter chips). */
